...
from sklearn.metrics import mean_absolute_error # NEW: For calculating 2025 accuracy
import webbrowser
import os
...
# ==========================================
# 5. CREATE TRAIN, VALIDATE, AND TEST SETS
# ==========================================
...
print("\nSearching for best model parameters using 2024 as the Validation Set...")
...
# --- NEW: Evaluate the model on the 2025 Test Set ---
print("\n" + "="*50)
print("Evaluating model accuracy on the 2025 Test Set...")
preds_2025 = best_rf_model.predict(X_test)
mae_2025 = mean_absolute_error(y_test, preds_2025)
print(f"🏈 2025 Test Accuracy: Predictions were off by an average of {mae_2025:.2f} PPG")
print("="*50 + "\n")
...
# To project 2026, we format the 2025 stats to act as our "previous year" features
...
<body>
    <h1>🏈 2026 Fantasy Football Projections (Tested on 2025 Data) 🏈</h1>
"""
