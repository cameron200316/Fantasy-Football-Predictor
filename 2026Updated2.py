...
# --- NEW: Grab the 'headshot' column along with birth_date ---
...
# ==========================================
# --- NEW: Merge player_info (which now includes headshot) ---
...
print("Training the advanced model with defensive EPA features...")
...
# Start building an HTML string with some basic styling
html_content = """
<html>
<head>
...
<body>
    <h1>🏈 2026 Fantasy Football Projections (Advanced EPA Model) 🏈</h1>
"""
...
for pos in ['QB', 'RB', 'WR', 'TE']:
    ...
    # Create HTML image tags for the headshots
    ...
    # Convert DataFrame to HTML (escape=False allows the <img> tags to render)
